...
function imagegridly_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'postpage_settings', array(
		'title'      => __('Posts/Page Settings','imagegridly'),
		'priority'   => 1,
		'capability' => 'edit_theme_options',
		) );

	$wp_customize->add_setting( 'postpage_thumbnail', array(
		'default' => 0,
		'sanitize_callback' => 'sanitize_text_field',
		) );

	$wp_customize->add_control( 'postpage_thumbnail', array(
		'label'    => __( 'Show Featured Images on Posts & Pages', 'imagegridly' ),
		'section'  => 'postpage_settings',
		'priority' => 1,
		'settings' => 'postpage_thumbnail',
		'type'     => 'checkbox',
		) );
